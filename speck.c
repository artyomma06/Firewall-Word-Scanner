...
//sourcing Eugene chow for Hash function and sourcing the people below for
//the encryption below
...
//
// Wrapper function to get a 32-bit hash values by using SPECK's key hash.
